    ...
    <Section>
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {informacoes.map((info) => {
          ...
          return (
            <div key={info.title} className="RevealText rounded-3xl border border-[color:#D9D9D9] bg-background p-8 transition-all hover:-translate-y-1 hover:shadow-[var(--shadow-card)]">
              <div
